...
def suggest_books():
    ...
    emotion_input = input("To propose the suitable story, tell me what emotion you would like to feel while reading: anger, fear, joy, neutral, sadness, disgust, surprise.\n")
